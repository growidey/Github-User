package com.dheaninda.part1.adapter
...
import com.dheaninda.part1.ui.FollowersFragment
import com.dheaninda.part1.ui.FollowingFragment
...
class SectionPagerAdapter(private val mCtx: Context, fm: FragmentManager, data: Bundle): FragmentPagerAdapter(fm, BEHAVIOR_RESUME_ONLY_CURRENT_FRAGMENT) {
    ...
    @StringRes
    private val TAB_NAME = intArrayOf(R.string.tab1, R.string.tab2)
